...
<body data-layout="horizontal" data-topbar="dark" data-bs-theme="dark">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);" class="has-arrow">
                                ...
                                <span class="menu-item" data-key="t-ui-elements">Admin</span>
                            </a>
                            {{-- <ul class="sub-menu" aria-expanded="false">
                    ...
                    <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                        ...
                        <div class="collapse navbar-collapse" id="topnav-menu-content">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="{{ route('super.add') }}" id="topnav-uielement" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="icon nav-icon" data-eva="cube-outline"></i>
                                        <span data-key="t-elements">Admins</span>
                                        {{-- <div class="arrow-down"></div> --}}
                                    </a>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages" role="button">
                                        <i class="icon nav-icon" data-eva="archive-outline"></i>
                                        <span data-key="t-apps">Donnés d'actions</span>
                                        <div class="arrow-down"></div>
                                    </a>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="{{ route('super.subscribe') }}" id="topnav-components" role="button">
                                        <i class="icon nav-icon" data-eva="layers-outline"></i>
                                        <span data-key="t-components">Abonnements</span>
                                        {{-- <div class="arrow-down"></div> --}}
                                    </a>
    ...
    <!-- gridjs js -->
    <script src="/back/assets/libs/gridjs/gridjs.umd.js"></script>

    <script src="/back/assets/js/pages/gridjs.init.js"></script>
