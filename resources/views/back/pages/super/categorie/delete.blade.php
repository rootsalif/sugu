...
<form action="{{ route('super.categorie.destroy', $categorie) }}" method="POST">
    @csrf
    @method('delete')
    @include('back.pages.include.alert-delete', ['name'=>$categorie->label_categorie, 'url'=>'super.categorie.index'])
    {{-- <div class="container">
