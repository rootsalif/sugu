@extends('back.layout.super-layout.auth-layout')
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mt-2">S'identifier pour continuer.</p>
                                        </div>
                                        @if (Session::get('fail'))
                                        ...
                                        @endif
                                        <form class="mt-4 pt-2" action="{{ route('super.logfrom') }}" method="POST">
                                            @csrf
                                            @method('post')
                                            <div class="form-floating form-floating-custom mb-4">
                                                <input type="text" name="email" value="{{ old('email_super') }}" class="form-control" id="input-username" placeholder="Entre l'Email">
