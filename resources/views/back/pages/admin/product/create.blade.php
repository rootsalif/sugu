...
@endpush
                                ...
                                <div id="addproduct-accordion" class="custom-accordion">
                                            ...
                                            <div class="p-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <div class="avatar-title font-size-16 rounded-circle bg-primary-subtle  text-primary">
                                                                01
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="addproduct-img-collapse" class="collapse" data-bs-parent="#addproduct-accordion">
                                            <div class="p-4 border-top">
                                                <form action="post" class="dropzone" enctype="multipart/form-data">
                                                    <div class="fallback">
                        ...
                        <div class="row mb-4">
                            <div class="col text-end">
                                ...
                                <a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#success-btn"> <i class="mdi mdi-file-document-outline me-1"></i> Save </a>
                            </div> <!-- end col -->
                        </div> <!-- end row-->
        ...
        <!-- choices js -->
        <script src="/back/assets/libs/choices.js/public//back/assets/scripts/choices.min.js"></script>

        <!-- dropzone plugin -->
        <script src="/back/assets/libs/dropzone/dropzone.js"></script>

        <!-- init js -->
        <script src="/back/assets/js/pages/ecommerce-choices.init.js"></script>
