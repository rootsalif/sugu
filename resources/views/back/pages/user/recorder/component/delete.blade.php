...
<form action="{{ route('user.component.destroy', $component) }}" method="POST">
    @csrf
    @method('delete')
    @include('back.pages.include.alert-delete', ['name'=>$component->label_component, 'url'=>'user.component.index'])
    {{-- <div class="container">
