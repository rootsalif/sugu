...
<div class="col-xl-8 mx-auto" >
    <div class="card">
        <div class="card-header">
            <h2>{{$size->exists ? 'Modifier ': 'Création '}}des sizes</h2>

            <p class="text-info">Definir les size pour les utilisateur du système</p>
        </div>
        <div class="card-body">



            <form id="myForm" action="{{ route($size->exists ? 'user.size.update' : 'user.size.store', $size) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method($size->exists ? 'PUT' : 'POST')
        
                <div class="mt-4">
                    <h5 class="font-size-24 mb-3">size du système</h5>
                ...
                <div class="row justify-content-center card-body">
                    ...
                    <div class="justify-content-start d-flex col-xl-4">
                        @include('back.pages.include.btn-submit',[
                            'name' => $size->exists ? 'Modifier' : 'Ajouter',
                            'class' => 'btn-primary',
                            'id'=>'addButton',
                            'type' => 'submit',
                            'data' => $size,
